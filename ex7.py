...
'''
# Write a function called find_factors which accepts a number and returns a list of
# all of the numbers which are is divisible by starting from 1 and going up to the number.
def find_factors(l):
